...
local PlatformWorld <const> = PlatformWorld -- 10
...
local GroupPlayer, GroupEnemy, GroupPlayerBlock, GroupEnemyBlock, GroupTerrain, GroupDisplay, LayerBlock, LayerBunny, LayerSwitch, LayerPlayerHero, LayerEnemyHero, LayerBackground = Store.GroupPlayer, Store.GroupEnemy, Store.GroupPlayerBlock, Store.GroupEnemyBlock, Store.GroupTerrain, Store.GroupDisplay, Store.LayerBlock, Store.LayerBunny, Store.LayerSwitch, Store.LayerPlayerHero, Store.LayerEnemyHero, Store.LayerBackground -- 13
local _anon_func_0 = function(GroupTerrain, LayerBackground, self, terrainDef) -- 44
	local _with_0 = Body(terrainDef, self, Vec2.zero) -- 44
	_with_0.order = LayerBackground -- 45
	_with_0.group = GroupTerrain -- 46
	return _with_0 -- 44
end -- 44
local _anon_func_1 = function(LayerBackground) -- 48
...
local _anon_func_3 = function(_with_0, i) -- 59
...
local _anon_func_2 = function(LayerBackground) -- 55
	local _with_0 = Node() -- 55
	_with_0.order = LayerBackground -- 56
	_with_0.y = -44 -- 57
	for i = 0, 32 do -- 58
		_with_0:addChild(_anon_func_3(_with_0, i)) -- 59
	end -- 58
	return _with_0 -- 55
end -- 55
local _anon_func_4 = function(GroupEnemy, GroupPlayer, LayerBunny, group) -- 212
	local _with_0 = { } -- 212
...
local _anon_func_5 = function(GroupEnemy, GroupPlayer, LayerBunny, group) -- 221
	local _with_0 = { } -- 221
...
local GameWorld = Class(PlatformWorld, { -- 29
	__init = function(self) -- 29
		...
		return self:onAppChange(function(settingName) -- 33
			if settingName == "Size" then -- 33
	...
	buildBackground = function(self) -- 36
		...
		self:addChild(_anon_func_0(GroupTerrain, LayerBackground, self, terrainDef)) -- 44
		self:addChild(_anon_func_1(LayerBackground)) -- 48
		return self:addChild(_anon_func_2(LayerBackground)) -- 55
	end, -- 36
	...
	buildCastles = function(_self) -- 113
		local Block -- 114
	...
	buildSwitches = function(_self) -- 189
		local Switch -- 190
	...
	addBunnySwither = function(_self, group) -- 202
		...
		if not switchGExist then -- 211
			Entity(_anon_func_4(GroupEnemy, GroupPlayer, LayerBunny, group)) -- 212
		end -- 211
		if not switchNExist then -- 220
			return Entity(_anon_func_5(GroupEnemy, GroupPlayer, LayerBunny, group)) -- 221
		end -- 220
	end, -- 202
