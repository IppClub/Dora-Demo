...
- [水果 2048](Fruit%202048/README.md)：采用程序化水果插画的竖屏友好解谜游戏，支持滑动与键盘操作、合成动画和最高分存档。
- [奇怪的贪吃蛇](Strange%20Snake/README.md)：霓虹风格的贪吃蛇与打砖块融合玩法，使用挡板反弹蛇头追逐单个随机食物，支持鼠标、键盘和触控。
- [云际巡航](Cloud%20Cruise/README.md)：拖动升降、松手定高的惯性飞行游戏，包含独立运动的管道、封顶难度梯度与横竖屏布局。
